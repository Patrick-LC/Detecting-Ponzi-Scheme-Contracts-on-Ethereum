...
# 训练神经网络模型
history = model.fit(X_train, Y_train_nn, batch_size=64, epochs=140, verbose=1,
...
print("Confusion Matrix - Neural Network Classifier:")
print(nn_cm)

# 绘制混淆矩阵图
labels = ['Not Fraud', 'Fraud']
sns.heatmap(nn_cm, annot=True, fmt="d", cmap="Blues", xticklabels=labels, yticklabels=labels)
